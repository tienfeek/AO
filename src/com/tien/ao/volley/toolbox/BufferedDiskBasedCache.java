...
import com.tien.ao.volley.VolleyLog;



/**
 * Cache implementation that caches files directly onto the hard disk in the specified directory. The default
 * disk usage size is 5MB, but is configurable. Noticing that the Volley cache used a lot of small (1 byte) IO
 * read/writes. I cloned DiskBasedCache.java and encapsulating all FileInputStreams and FileOutputStreams with
 * BufferedInputStream and BufferedOutputStreams. I found that that this optimization gave me a 3-10 times
 * speed up.
 * 
...
public class BufferedDiskBasedCache implements Cache {
	...
	/**
	 * Constructs an instance of the DiskBasedCache at the specified directory using the default maximum cache
	 * size of 5MB.
	 * 
	 * @param rootDirectory
	 *            The root directory of the cache.
	...
	/*
	 * Homebrewed simple serialization system used for reading and writing cache headers on disk. Once upon a
	 * time, this used the standard Java Object{Input,Output}Stream, but the default implementation relies
	 * heavily on reflection (even for standard types) and generates a ton of garbage.
	 */
