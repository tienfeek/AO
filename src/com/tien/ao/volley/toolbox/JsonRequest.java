...
public abstract class JsonRequest<T> extends Request<T> {
    ...
    public JsonRequest(String url, Map<String, String> params, Listener<T> listener,
            ErrorListener errorListener) {
        this(Method.DEPRECATED_GET_OR_POST, url, params, listener, errorListener);
    }
    
    public JsonRequest(int method, String url, Map<String, String> params, Listener<T> listener,
            ErrorListener errorListener) {
        super(method, url, errorListener, params);
        mListener = listener;
        mRequestBody = null;
    }
