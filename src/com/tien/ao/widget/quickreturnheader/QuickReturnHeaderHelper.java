 ...
 */
package com.tien.ao.widget.quickreturnheader;

import com.tien.ao.R;
import com.tien.ao.utils.DimensionUtil;
...
public class QuickReturnHeaderHelper implements OnGlobalLayoutListener {
    ...
    public View createView() {
        ...
        float height = context.getResources().getDimension(R.dimen.sticky_height);
